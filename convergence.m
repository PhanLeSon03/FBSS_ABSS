...
alpha1  = 0.0001;            % step-size for upper path (if adapted – usually fixed)
alpha2s = [0.0001, 0.001, 0.01];   % candidates for lower path
...
for i_sir = 1:length(SIR_vec)
    ...
    for i_alpha = 1:length(alpha2s)
        ...
        plot(it, avg_e2_base, '--', ...
            ...
            'LineWidth',1.5, ...
            'DisplayName', sprintf('Base, \\alpha_2 = %.3f', alpha2s(i_alpha)));
        ...
        plot(it, avg_e2_prop, '-', ...
            ...
            'LineWidth',1.8, ...
            'MarkerSize',6, ...
            'DisplayName', sprintf('Proposed, \\alpha_2 = %.3f', alpha2s(i_alpha)));
    end
